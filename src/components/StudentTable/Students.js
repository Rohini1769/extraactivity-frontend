...
const  Students =()=> {
  ...
  const handleViewClick = (id) => () => {
    axios
      .get(`https://activitymanagement.up.railway.app/profile`,{
        params: { email: id },
      })
      .then((response) => {
  ...
  const handleSaveStudent = () => {
    ...
    axios
      .post('https://activitymanagement.up.railway.app/add', formData)
      .then((response) => {
        const newRow = { 
  ...
  useEffect(() => {
    axios.get('https://activitymanagement.up.railway.app/viewall')
      .then(response => {
  ...
  const handleSaveClick = (id) => () => {
    ...
    axios
      .put('https://activitymanagement.up.railway.app/update', student)
      .then((response) => {
  ...
  const handleDeleteClick = (id) => () => {
    axios
      .delete(`https://activitymanagement.up.railway.app/delete?email=${id}`)
      .then(() => {
...
const handleRegisteredEventsClick = (row) => {
  ...
  axios
    .get('https://activitymanagement.up.railway.app/registered-events', {
...
const closeEventsOverlay = () => {
  ...
  const handleRemoveRegistration = (email, eventName) => {
    axios
      .delete('https://activitymanagement.up.railway.app/unregister', {
