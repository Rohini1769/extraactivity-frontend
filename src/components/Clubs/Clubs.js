...
const Clubs = () => {
    ...
    const handleAddClub = () => {
        ...
        axios.post('https://activitymanagement.up.railway.app/addclub', formData, {
    ...
    const fetchClubs = () => {
        axios.get('https://activitymanagement.up.railway.app/viewclubs')
            .then((response) => setClubsData(response.data))
            .catch((error) => console.log('Error fetching clubs:', error));
    };

    const handleViewClub = (clubName) => {
        axios.get(`https://activitymanagement.up.railway.app/view-club?clubName=${clubName}`)
            .then((response) => {
    ...
    const handleEditingClub = () => {
        ...
        axios.post('https://activitymanagement.up.railway.app/editclub', formData, {
            headers: { 'Content-Type': 'multipart/form-data' },
        })
            .then(() => {
                fetchClubs();
