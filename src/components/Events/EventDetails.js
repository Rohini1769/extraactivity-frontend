...
const EventDetails = () => {
  ...
  useEffect(() => {
    const fetchEventDetails = async () => {
      try {
        const response = await fetch(`https://activitymanagement.up.railway.app/viewevent?eventname=${eventname}`);
        if (!response.ok) {
    ...
    const checkRegistrationStatus = async () => {
      if (studentEmail) {
        try {
          const response = await axios.get(`https://activitymanagement.up.railway.app/check-registration`, {
            params: {
              email: studentEmail,
              eventname: eventname,
            },
  ...
  const handleRegister = () => {
    ...
    axios.post(`https://activitymanagement.up.railway.app/register`, null, {
      params: {
        email: studentEmail,
        eventname: eventname,
      },
  ...
  const handleUnregister = () => {
    ...
    axios.delete(`https://activitymanagement.up.railway.app/unregister`, {
      params: {
        email: studentEmail,
        eventname: eventname,
      },
